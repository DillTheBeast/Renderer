// //Compile with: g++ -std=c++11 -o OddTriangle OddTriangle.cpp ./src/glad.c -I./include/ -I./glfw-3.3.8/include -L./glfw-3.3.8/src -lglfw3 -ldl -lpthread -framework Cocoa -framework OpenGL -framework IOKit -framework CoreVideo
#include <glad/glad.h>
